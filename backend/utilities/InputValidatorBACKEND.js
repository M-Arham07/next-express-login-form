...
// INPUT VALIDATOR FOR BACKEND (MADE BY M-Arham07)

// only difference is that it uses module.exports instead of exporting functions

function ValidateLogin_Input(email, password) {
...
function ValidateSignUP_Input(new_email, new_password,confirmed_password){
